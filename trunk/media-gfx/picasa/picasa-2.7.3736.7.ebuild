...
src_install() {
	...
	mv google-picasa.directory.template google-picasa.directory
	...
	sed -i -e "s:ICON:picasa.xpm:" google-picasa{{,-mediadetector}.desktop,.directory}
	...
	doins google-picasa.directory
}

pkg_postinst() {
	xdg-desktop-menu install /usr/share/desktop-directories/google-picasa.directory /usr/share/applications/google-picasa{,-mediadetector,-fontcfg}.desktop
}
